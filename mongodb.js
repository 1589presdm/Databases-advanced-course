...
export async function addManyData(count) {
  const db = await connect();
  const firstnames = ['Keijo', 'Tuomas', 'Teemu', 'Jyrki', 'Ilkka', 'Juuso', 'Lauri', 'Risto', 'Timo', 'Mika'];
  const surnames = ['Liukkonen', 'Turunen', 'Kärnä', 'Halonen', 'Järvinen', 'Karhunen', 'Neuvonen', 'Koskinen', 'Sotikov'];
